...
trainFile = '/sb-personal/cvqa/data/cvqa/cvqa-sameQuestionDataset-subset-list4-train.json'
testFile = '/sb-personal/cvqa/data/cvqa/cvqa-sameQuestionDataset-subset-list4-test.json'
...
decoder.fit(X_questions_train,y_train, nb_epoch=numberOfEpochs, verbose=1)
